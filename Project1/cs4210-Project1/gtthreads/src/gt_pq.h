...
extern void sched_account_runtime(kthread_runqueue_t *kthread_runq, uthread_struct_t *u, int used);
extern void print_active_runqueue_summary(kthread_runqueue_t *kthread_runq);
...
/* Find the uthread next for scheduling.
